 ...
 * having to track colors everywhere: just ask the ColorManager for a color ({@link #getColor(RGB)})
 * and it will manage it for you. The only thing you have to do to release the resources, is to
 * dispose the ColorManager ({@link #dispose()}) when you don't need it anymore.
 *
...
public class ColorManager {
    ...
    /**
     * Dispose of this ColorManager and all created colors.
     */
    public void dispose() {
